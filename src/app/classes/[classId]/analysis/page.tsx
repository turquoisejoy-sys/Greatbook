                      ...
                      {student.casasReadingProgress !== null ? (
                        <div>
                          ...
                          <div className="text-xs text-gray-400 mt-0.5">
                            last: {student.casasReadingLast?.toFixed(0)}
                          </div>
                        </div>
                      ) : (
                    ...
                    <td className="text-center">
                      {student.casasListeningProgress !== null ? (
                        <div>
                          ...
                          <div className="text-xs text-gray-400 mt-0.5">
                            last: {student.casasListeningLast?.toFixed(0)}
                          </div>
                        </div>
                      ) : (
                        <span className="text-gray-400">—</span>
      ...
      <div className="card print:hidden">
        ...
        <div className="text-sm text-gray-600 grid grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-xs text-gray-400">Progress = (Last Score - {currentClass.casasReadingLevelStart}) ÷ {currentClass.casasReadingTarget - currentClass.casasReadingLevelStart} × 100</p>
          </div>
          <div>
            <p><strong>Listening:</strong> {currentClass.casasListeningLevelStart} → {currentClass.casasListeningTarget}</p>
            <p className="text-xs text-gray-400">Progress = (Last Score - {currentClass.casasListeningLevelStart}) ÷ {currentClass.casasListeningTarget - currentClass.casasListeningLevelStart} × 100</p>
          </div>
        </div>
      </div>
    </div>
